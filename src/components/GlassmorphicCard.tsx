...
export function GlassmorphicCard({ children, className = "" }: GlassmorphicCardProps) {
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
    >
      <div className={`relative overflow-hidden rounded-xl bg-black/50 backdrop-blur-sm border border-green-500/30 p-6 transition-all duration-300 hover:border-green-500/60 card-glow ${className}`}>
